...
namespace Lab4v3
{
    public class UkkonenTrie<T>: ITrie<T>
    {
        ...
        public static bool RegionMatches(string first, int toffset, string second, int ooffset, int len)
        {
            for (var i = 0; i < len; i++)
            {
         ...
         *         
         */
        public static Tuple<bool, Node<T>> TestAndSplit(Node<T> inputs, string stringPart, char t, string remainder, T value)
        {
         ...
         */
        public static Tuple<Node<T>, string> Canonize(Node<T> s, string inputstr)
        {
         ...
         * @param value the value to add to the index
         */
        public Tuple<Node<T>, string> Update(Node<T> inputNode, string stringPart, string rest, T value)
        {
            var s = inputNode;
        ...
        public static string SafeCutLastChar(string seq)
        {
